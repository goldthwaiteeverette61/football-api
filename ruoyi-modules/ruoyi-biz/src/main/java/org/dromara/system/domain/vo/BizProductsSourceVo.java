...
@AutoMapper(target = BizProductsSource.class)
public class BizProductsSourceVo implements Serializable {
     ...
     * 翻译完成：0，未完成；1，已完成。
     */
    @ExcelProperty(value = "翻译完成：0，未完成；1，已完成。")
