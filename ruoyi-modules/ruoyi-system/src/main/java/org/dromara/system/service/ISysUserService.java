...
public interface ISysUserService {
     ...
     */
    void verifyPayPassword(Long userId, String payPassword);

    void setUserAsAgent(Long userId);

    void setPayPassword(SetPayPasswordBo bo);
     ...
     * @return 用户列表
     */
    List<SysUser> selectUserListByIds(Collection<Long> ids);

    SysUser selectUserByInvitationCode(String invitationCode);
     ...
     * @return 结果
     */
    int resetUserPayPwd(Long userId, String payPassword);
     ...
     * @return 结果
     */
    boolean registerUserFront(SysUserBo user);

    List<SysUserVo> selectUserList(SysUserBo sysUserBo);
