...
public class SysConfigServiceImpl implements ISysConfigService, ConfigService {
    ...
    @Override
    public BigDecimal rewardPersent() {
        return new BigDecimal(this.selectConfigByKey("sys.biz.rewardPersent"));
    }

    @Override
    public BigDecimal rewardPersentNormal() {
        return new BigDecimal(this.selectConfigByKey("sys.biz.rewardPersentNormal"));
    }
    ...
    @Override
    public Integer lossesThresholdForReward() {
        return Integer.parseInt(this.selectConfigByKey("sys.biz.lossesThresholdForReward"));
    }


    @Override
    public BigDecimal baseBetAmount() {
        return new BigDecimal(this.selectConfigByKey("sys.biz.baseBetAmount"));
    }
}
