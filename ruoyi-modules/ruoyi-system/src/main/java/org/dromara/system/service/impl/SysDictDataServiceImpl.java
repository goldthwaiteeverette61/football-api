...
public class SysDictDataServiceImpl implements ISysDictDataService {
    ...
    /**
     * 【核心新增】实现获取默认头像的方法，并添加缓存
     * 缓存名为 "sys_dict"，键为 "default_user_logo"
     */
    @Override
    @Cacheable(cacheNames = CacheNames.SYS_DICT)
    public List<SysDictDataVo> selectDefaultUserAvatars() {
        SysDictDataBo sysDictDataBo = new SysDictDataBo();
        sysDictDataBo.setDictType("default_user_logo");
        return this.selectDictDataList(sysDictDataBo);
    }
